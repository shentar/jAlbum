 ...
 */
JNIEXPORT jstring JNICALL Java_org_sqlite_core_NativeDB_errmsg
  (JNIEnv *, jobject);
 ...
 * Signature: (JLjava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_org_sqlite_core_NativeDB_result_1error
  (JNIEnv *, jobject, jlong, jstring);
 ...
 */
JNIEXPORT jint JNICALL Java_org_sqlite_core_NativeDB_value_1bytes
 ...
 * Class:     org_sqlite_core_NativeDB
 * Method:    backup
 * Signature: (Ljava/lang/String;Ljava/lang/String;Lorg/sqlite/core/DB/ProgressObserver;)I
 */
