...
public class WebFilter implements Filter
{
            ...
            throws IOException, ServletException
    {
        try
        {
            ...
            logger.warn("get a request: " + System.nanoTime() + " the remote port is: " + req.getRemotePort());
            ...
            logger.warn("done a request: " + System.nanoTime() + " the remote port is: " + req.getRemotePort());
        }
        finally
        {
